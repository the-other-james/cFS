...
SET(TGT1_NAME cpu1)
if(DEFINED ENV{TGT1_APPLIST})
  message (STATUS "Using envirnmental app list")
  SET(TGT1_APPLIST $ENV{TGT1_APPLIST})
else(DEFINED ENV{TGT1_APPLIST})
  message (STATUS "Using target.cmake app list")
  SET(TGT1_APPLIST cf ds hk hs fm md ci_lab to_lab sch_lab)
endif(DEFINED ENV{TGT1_APPLIST})
SET(TGT1_FILELIST cfe_es_startup.scr)
SET(TGT1_SYSTEM ppc-vxworks6.9)
